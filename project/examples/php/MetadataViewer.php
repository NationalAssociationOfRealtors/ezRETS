  ...
  <tr>
    <td>
      <table border=\"1\">
        ...
        <tr>
          <td><?= $name = odbc_result($tableexec, "TABLE_NAME"); ?></td>
          <td><?= odbc_result($tableexec, "REMARKS"); ?></td>
<?
    // number of columns.  Need to look them up first.  
    $colexec = odbc_columns($conn, "", "", $name);
?>
          <td><?= odbc_num_fields($colexec); ?></td>
        </tr>
        <tr>
...
?>
                    <tr>
                      <td><?= odbc_result($colexec, "COLUMN_NAME"); ?></td>
                      <td><?= odbc_result($colexec, "REMARKS"); ?></td>
                      <td><?= odbc_result($colexec, "TYPE_NAME"); ?></td>
                      <td><?= odbc_result($colexec, "COLUMN_SIZE"); ?></td>
                    </tr>
<?
