...
EXAMPLES_BIN_DIR = build/examples/bin
...
CONTEST_EXE = ${EXAMPLES_BIN_DIR}/ConnectTest
...
SIMPLESEARCH_EXE = ${EXAMPLES_BIN_DIR}/SimpleSearch
...
NOWHERESEARCH_EXE = ${EXAMPLES_BIN_DIR}/NoWhereSearch
...
TABLESTEST_EXE = ${EXAMPLES_BIN_DIR}/TablesTest
...
COLUMNSTEST_EXE = ${EXAMPLES_BIN_DIR}/ColumnsTest
...
FORCEDERROR_EXE = ${EXAMPLES_BIN_DIR}/ForcedError
...
FLOATERROR_EXE = ${EXAMPLES_BIN_DIR}/FloatError
...
DRIVCONTEST_EXE = ${EXAMPLES_BIN_DIR}/SQLDriverConnectTest
...
SIMPLEGETDATA_EXE = ${EXAMPLES_BIN_DIR}/SimpleGetData

EXECUTEQUERY_EXAMPLE_SRC_FILES := $(EXAMPLES_COMMON_SRC) ${EXAMPLES_SRC_DIR}/ExecuteQuery.cpp
EXECUTEQUERY_EXAMPLE_OBJECTS    := $(patsubst $(EXAMPLES_SRC_DIR)/%.cpp, \
	$(EXAMPLES_OBJ_DIR)/%.o, $(EXECUTEQUERY_EXAMPLE_SRC_FILES))
EXECUTEQUERY_EXAMPLE_DEPENDS    := $(patsubst $(EXAMPLES_SRC_DIR)/%.cpp, \
	$(EXAMPLES_OBJ_DIR)/%.d, $(EXECUTEQUERY_EXAMPLE_SRC_FILES))
EXECUTEQUERY_EXE = ${EXAMPLES_BIN_DIR}/ExecuteQuery
...
PRIMARYKEYS_EXE = ${EXAMPLES_BIN_DIR}/PrimaryKeys

NODSN_EXAMPLE_SRC_FILES := $(EXAMPLES_COMMON_SRC) ${EXAMPLES_SRC_DIR}/NoDsn.cpp
NODSN_EXAMPLE_OBJECTS := $(patsubst $(EXAMPLES_SRC_DIR)/%.cpp, \
		$(EXAMPLES_OBJ_DIR)/%.o, $(NODSN_EXAMPLE_SRC_FILES))
NODSN_EXAMPLE_DEPENDS    := $(patsubst $(EXAMPLES_SRC_DIR)/%.cpp, \
		$(EXAMPLES_OBJ_DIR)/%.d, $(NODSN_EXAMPLE_SRC_FILES))
NODSN_EXE = ${EXAMPLES_BIN_DIR}/NoDsn

PONLY_EXAMPLE_SRC_FILES := $(EXAMPLES_COMMON_SRC)\
                           ${EXAMPLES_SRC_DIR}/SQLPrepareOnly.cpp
PONLY_EXAMPLE_OBJECTS := $(patsubst $(EXAMPLES_SRC_DIR)/%.cpp, \
		$(EXAMPLES_OBJ_DIR)/%.o, $(PONLY_EXAMPLE_SRC_FILES))
PONLY_EXAMPLE_DEPENDS    := $(patsubst $(EXAMPLES_SRC_DIR)/%.cpp, \
		$(EXAMPLES_OBJ_DIR)/%.d, $(PONLY_EXAMPLE_SRC_FILES))
PONLY_EXE = ${EXAMPLES_BIN_DIR}/SQLPrepareOnly

EXAMPLES_DEPENDS = $(CONTEST_EXAMPLE_DEPENDS) $(SIMPLESEARCH_EXAMPLE_DEPENDS) $(NOWHERESEARCH_EXAMPLE_DEPENDS) $(DRIVCONTEST_DEPENDS) $(FORCEDERROR_EXAMPLE_DEPENDS) $(TABLESTEST_EXAMPLE_DEPENDS) $(COLUMNSTEST_EXAMPLE_DEPENDS) $(FLOATERROR_DEPENDS) $(SIMPLEGETDATA_EXAMPLE_DEPENDS) $(EXECUTEQUERY_EXAMPLE_DEPENDS) $(PRIMARYKEYS_EXAMPLES_DEPENDS) $(NODSN_EXAMPLE_DEPENDS) $(PONLY_EXAMPLE_DEPENDS)
EXAMPLES_EXE = $(CONTEST_EXE) $(SIMPLESEARCH_EXE) $(NOWHERESEARCH_EXE) $(DRIVCONTEST_EXE) $(FORCEDERROR_EXE) $(TABLESTEST_EXE) $(COLUMNSTEST_EXE) $(FLOATERROR_EXE) $(SIMPLEGETDATA_EXE) $(EXECUTEQUERY_EXE) $(PRIMARYKEYS_EXE) $(NODSN_EXE) $(PONLY_EXE)
...
$(EXECUTEQUERY_EXE): $(EXECUTEQUERY_EXAMPLE_OBJECTS)
	$(CXX) -o $(EXECUTEQUERY_EXE) $(EXECUTEQUERY_EXAMPLE_OBJECTS) -lodbc -lboost_regex

$(PRIMARYKEYS_EXE): $(PRIMARYKEYS_EXAMPLE_OBJECTS)
	$(CXX) -o $(PRIMARYKEYS_EXE) $(PRIMARYKEYS_EXAMPLE_OBJECTS) -lodbc

$(NODSN_EXE): $(NODSN_EXAMPLE_OBJECTS)
	$(CXX) -o $(NODSN_EXE) $(NODSN_EXAMPLE_OBJECTS) -lodbc

$(PONLY_EXE): $(PONLY_EXAMPLE_OBJECTS)
	$(CXX) -o $(PONLY_EXE) $(PONLY_EXAMPLE_OBJECTS) -lodbc
