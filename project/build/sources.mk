...
NODSN_EXAMPLE_SRC_FILES := $(EXAMPLES_COMMON_SRC) \
				 ${EXAMPLES_SRC_DIR}/NoDsn.cpp
...
NODSN_EXE = build/examples/bin/NoDsn

EXAMPLES_DEPENDS = $(CONTEST_EXAMPLE_DEPENDS) $(SIMPLESEARCH_EXAMPLE_DEPENDS) $(NOWHERESEARCH_EXAMPLE_DEPENDS) $(DRIVCONTEST_DEPENDS) $(FORCEDERROR_EXAMPLE_DEPENDS) $(TABLESTEST_EXAMPLE_DEPENDS) $(COLUMNSTEST_EXAMPLE_DEPENDS) $(FLOATERROR_DEPENDS) $(SIMPLEGETDATA_EXAMPLE_DEPENDS) $(PRIMARYKEYS_EXAMPLES_DEPENDS) $(NODSN_EXAMPLE_DEPENDS)
EXAMPLES_EXE = $(CONTEST_EXE) $(SIMPLESEARCH_EXE) $(NOWHERESEARCH_EXE) $(DRIVCONTEST_EXE) $(FORCEDERROR_EXE) $(TABLESTEST_EXE) $(COLUMNSTEST_EXE) $(FLOATERROR_EXE) $(SIMPLEGETDATA_EXE) $(PRIMARYKEYS_EXE) $(NODSN_EXE)
